...
reveal_normal_deck_test() ->
  ...
  {{red, ny}, [{black, delhi}], [{red, ny}, {blue, rio}]} = reveal(Deck, Pile).
...
discard_card_in_hand_test() ->
  ...
  {[{blue, rio}], [{red, ny}, {black, delhi}]} = discard(Card, Hand, Discard).
...
initial_hand_for_two_players_test() ->
  ...
  Player1 = [1,3,5,7],
  Player2 = [2,4,6,8],
  {NewDeck, [Player1, Player2]} = initial_hand(PlayerDeck, 2).
...
initial_hand_for_three_players_test() ->
  ...
  Player2 = [2,5,8],
  Player3 = [3,6,9],
  {NewDeck, [Player1, Player2, Player3]} = initial_hand(PlayerDeck, 3).
...
initial_hand_for_four_players_test() ->
  ...
  Player3 = [3,7],
  Player4 = [4,8],
  {NewDeck, [Player1, Player2, Player3, Player4]} = initial_hand(PlayerDeck, 4).
...
initial_hand_for_five_players_test() ->
  ...
  Player4 = [4,9],
  Player5 = [5,10],
  {NewDeck, [Player1, Player2, Player3, Player4, Player5]} = initial_hand(PlayerDeck, 5).

initial_hand_with_invalid_deck_test() ->
  PlayerDeck = [],
  ?assertExit(invalid_player_deck, initial_hand(PlayerDeck, 2)).
